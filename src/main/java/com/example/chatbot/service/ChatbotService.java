...
public class ChatbotService {
    ...
    String systemPrompt =
            "너는 루키즈 티켓 서비스의 대화형 챗봇이야. 사용자가 입력한 질문에 대해서 스스로 판단해서, 대화를 이어가줘.\n\n" +
                    ...
                    "1. http부터 출력\n" +
                    "2. 추가적인 설명 금지\n" +
                    "3. 단어 뜻을 설명해주지말고 대화를 이어가줘\n" +
                    "4. 만약 위에있는 URL들 중 답변이 없는 것 같으면 대화형 대답을 해줘\n\n" +
                    "예시 : 사용자가 안녕? 할 경우 대답 : 안녕하세요 루키즈 티켓 챗봅입니다.";
